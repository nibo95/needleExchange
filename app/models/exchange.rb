class Exchange < ActiveRecord::Base
 ...
 #    validates_date :updated_at, :on_or_before => Date.today
    ...
    def total_returned_needles
    	return (75*one_qt) + (100*two_qt) + (700*three_gal) + (1200*eight_gal) + (200*bleach_bottle) + returned_needles
    end

    def total_needles_received
        return ultrafines + halfs + pogos + blues
    end
